...
void momentumEquation(const vector<vector<unsigned>> &neighbours_matrix, const double &mass, const vector<vector<double>> &gradW_matrix, const vector<double> &rho_arr, vector<double> p_arr, const string &state_equation_chosen);
