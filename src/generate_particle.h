...
void meshcube(vector<double> &o, vector<double> &L, double &s,
              std::vector<double> &pos_arr, std::vector<double> &type_arr);
...
void meshBoundary(vector<double> &o, vector<double> &L, double &s,
                  std::vector<double> &bound_arr, std::vector<double> &type_arr);
