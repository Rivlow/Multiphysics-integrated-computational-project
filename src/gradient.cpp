...
void setPressure(size_t nb_moving_part, vector<double> &p_arr,
                 vector<double> &rho_arr, double &rho_0,
                 double &c_0, double &R, double &T,
...
void setArtificialViscosity(int &t, vector<vector<double>> &artificial_visc,
                            size_t nb_moving_part, vector<double> &pos_arr,
                            vector<vector<int>> &neighbours_matrix,
                            vector<double> &rho_arr,
                            vector<double> &u_arr, double &alpha,
                            double &beta, double &rho_0, double &c_0,
                            double &gamma, double &R, double &T,
                            double &M, double &h,
                            string &state_equation_chosen)
{
...
void momentumEquation(size_t nb_moving_part,
                      ...
                      vector<double> &p_arr, double &R, double &T,
                      double &M, double &gamma,
                      double &g,
                      string &state_equation_chosen)
{
