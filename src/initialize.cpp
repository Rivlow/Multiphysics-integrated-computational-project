...
void initializeRho(unsigned &nb_moving_part, vector<double> &pos_arr, vector<double> &rho_arr,double &rho_moving, double &rho_fixed, double &rho_0, double &c_0, 
...
void initializeVelocity(unsigned &nb_moving_part, vector<double> &u_arr,vector<double> &u_init){
